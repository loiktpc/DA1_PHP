                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="table table-striped table-bordered zero-configuration dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 150px;">Tên Phân Loại</th>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($ShowListCate as $ShowList):
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="d-flex">
                                                            <a href="./index.php?pages=admin&layout=home&modulde=category&action=edit&id=<?=$id?>">
                                                                <button style="margin-right: 10px;" class="btn mb-1 btn-flat btn-primary">
                                                                    Sửa
                                                                </button>
                                                            </a>
                                                            <a href="./index.php?pages=admin&layout=home&modulde=category&action=delete&id=<?=$id?>">
